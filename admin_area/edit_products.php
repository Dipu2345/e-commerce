...
if (isset($_GET['edit_products'])) {
    ...
    $row__category = mysqli_fetch_assoc($result_category);
    $category_title = $row__category['category_title'];
    //echo $category_title;

    //fetching category name
    $select_brand = "Select * from brands where brand_id=$brand_id";
    $result_brand = mysqli_query($con, $select_brand);
    $row__brand = mysqli_fetch_assoc($result_brand);
    $brand_title = $row__brand['brand_title'];
    // echo $brand_title;
}
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <select name="product_category" class="form-select">
                ...
                while ($row__category_all = mysqli_fetch_assoc($result_category_all)) {
                    $category_title = $row__category_all['category_title'];
                    $category_id = $row__category_all['category_id'];
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <select name="product_brands" class="form-select">
                ...
                while ($row__brand_all = mysqli_fetch_assoc($result_brand_all)) {
                    $brand_title = $row__brand_all['brand_title'];
                    $brand_id = $row__brand_all['brand_id'];
        ...
        <div class="w-50 m-auto">
            <input type="submit" name="edit_product" value="UPDATE" class="btn cate px-3 mb-3">
        </div>
    </form>
</div>
