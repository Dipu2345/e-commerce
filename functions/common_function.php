              ...
              <div class='card'>
                <img src='./admin_area/product_images/$product_image1' class='card-img-top' alt='...'>
                   ...
                   <p class='card-text'>price: $product_price/-</p>
                    <a href='index.php?add_to_cart=$product_id' class='btn btn-info'><i class='fa-solid fa-cart-shopping'></i></a>
                    <a href='product_details.php?product_id=$product_id' class='btn btn-secondary'>more</a>
                 </div>
               </div>
              </div> ";
      }
...
function get_unique_brands()
{
  ...
  if (isset($_GET['brand'])) {
    ...
    $num_of_rows = mysqli_num_rows($result_query);
    if ($num_of_rows == 0) {
      echo "<h2 class='text-center text-danger'>This brand is not available for sevice</h2>";
    }
...
function total_cart_price()
{
  ...
  while ($row = mysqli_fetch_array($result)) {
    ...
    while ($row_product_price = mysqli_fetch_array($result_products)) {
      ...
      $total_price = $total_price + $product_values; //500
